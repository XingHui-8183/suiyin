package com.tool.btremote.media
...
class MediaListenerService : NotificationListenerService() {
    ...
    fun handleControlCommand(type: Int, position: Long? = null, volume: Int? = null) {
        ...
        try {
            when (type) {
                com.tool.btremote.protocol.MsgType.MEDIA_CMD_PLAY_PAUSE -> {
                ...
                com.tool.btremote.protocol.MsgType.MEDIA_CMD_NEXT -> {
                    controller.transportControls.skipToNext()
                }
                com.tool.btremote.protocol.MsgType.MEDIA_CMD_PREV -> {
                    controller.transportControls.skipToPrevious()
                }
                com.tool.btremote.protocol.MsgType.MEDIA_CMD_SEEK -> {
                    position?.let { controller.transportControls.seekTo(it) }
                }
                com.tool.btremote.protocol.MsgType.MEDIA_CMD_VOLUME -> {
                    if (volume != null) {
