...
class MediaSessionManager(private val context: Context) {
    ...
    companion object {
        ...
        const val ACTION_PLAY_PAUSE = "com.tool.btremote.media.PLAY_PAUSE"
        const val ACTION_NEXT = "com.tool.btremote.media.NEXT"
        const val ACTION_PREV = "com.tool.btremote.media.PREV"
    }
