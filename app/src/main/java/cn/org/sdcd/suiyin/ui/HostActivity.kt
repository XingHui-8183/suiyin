...
import cn.org.sdcd.suiyin.databinding.ActivityHostBinding
import cn.org.sdcd.suiyin.databinding.DialogNewSmsBinding
...
import cn.org.sdcd.suiyin.sms.SmsMessageItem
...
class HostActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        // 如果已连接,主动请求被控端上报当前状态,避免开关显示不同步
        if (currentState == BTConnectionManager.State.CONNECTED) {
            CoreService.instance?.sendMessage(BTMessage.requestState("all"))
        }
    }
